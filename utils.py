...
def read_files(diff_path: str = ''):
    ...
    X_train_estimated_c = pd.read_parquet(diff_path + settings.B.X_train_estimated)

    X_train_observed_a = pd.read_parquet(diff_path + settings.A.X_train_observed)
    X_train_observed_b = pd.read_parquet(diff_path + settings.A.X_train_observed)
    X_train_observed_c = pd.read_parquet(diff_path + settings.A.X_train_observed)

    X_test_estimated_a = pd.read_parquet(diff_path + settings.A.X_test_estimated)
    X_test_estimated_b = pd.read_parquet(diff_path + settings.A.X_test_estimated)
    X_test_estimated_c = pd.read_parquet(diff_path + settings.A.X_test_estimated)
